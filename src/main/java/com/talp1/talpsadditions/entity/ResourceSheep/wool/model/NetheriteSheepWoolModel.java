package com.talp1.talpsadditions.entity.ResourceSheep.wool.model;
...
@OnlyIn(Dist.CLIENT)
public class NetheriteSheepWoolModel<T extends NetheriteResourceSheep> extends QuadrupedModel<T> {
    private float headRotationAngleX;

    public NetheriteSheepWoolModel() {
