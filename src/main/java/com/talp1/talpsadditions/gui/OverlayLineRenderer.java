...
public class OverlayLineRenderer extends RenderType {

    // Dummy
    public OverlayLineRenderer(String name, VertexFormat format, int p_i225992_3_, int p_i225992_4_, boolean p_i225992_5_, boolean p_i225992_6_, Runnable runnablePre, Runnable runnablePost) {
