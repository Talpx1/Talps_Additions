...
public class BushGen {
    ...
    public static void generateBushes(BiomeLoadingEvent biome){
        ...
        BlockClusterFeatureConfig ORANGE_ROSE_CONFIG = new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(RegistryHandler.orange_rose.get().getDefaultState()),new DoublePlantBlockPlacer()).tries(12).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock())).func_227317_b_().build();
        BlockClusterFeatureConfig YELLOW_ROSE_CONFIG = new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(RegistryHandler.yellow_rose.get().getDefaultState()),new DoublePlantBlockPlacer()).tries(12).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock())).func_227317_b_().build();
        BlockClusterFeatureConfig GREEN_ROSE_CONFIG = new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(RegistryHandler.green_rose.get().getDefaultState()),new DoublePlantBlockPlacer()).tries(12).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock())).func_227317_b_().build();
        BlockClusterFeatureConfig MULTICOLOR_ROSE_CONFIG = new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(RegistryHandler.multicolor_rose.get().getDefaultState()),new DoublePlantBlockPlacer()).tries(12).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock())).func_227317_b_().build();
        BlockClusterFeatureConfig PURPLE_ROSE_CONFIG = new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(RegistryHandler.purple_rose.get().getDefaultState()),new DoublePlantBlockPlacer()).tries(12).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock())).func_227317_b_().build();
        BlockClusterFeatureConfig COCONUT_CONFIG = new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(RegistryHandler.coconut_block.get().getDefaultState()),new SimpleBlockPlacer()).tries(8).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK.getBlock(),Blocks.DIRT.getBlock(),Blocks.SAND.getBlock(),Blocks.RED_SAND.getBlock())).func_227317_b_().build();
