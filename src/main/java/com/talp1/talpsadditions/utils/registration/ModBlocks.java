...
public class ModBlocks {
    ...
    public static final RegistryObject<HydrangeaBlock> white_hydrangea = BLOCKS.register("white_hydrangea", () -> new HydrangeaBlock(AbstractBlock.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.SWEET_BERRY_BUSH),1));
    public static final RegistryObject<HydrangeaBlock> red_hydrangea = BLOCKS.register("red_hydrangea", () -> new HydrangeaBlock(AbstractBlock.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.SWEET_BERRY_BUSH),2));
    public static final RegistryObject<HydrangeaBlock> pink_hydrangea = BLOCKS.register("pink_hydrangea", () -> new HydrangeaBlock(AbstractBlock.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.SWEET_BERRY_BUSH),3));
    public static final RegistryObject<HydrangeaBlock> lilac_hydrangea = BLOCKS.register("lilac_hydrangea", () -> new HydrangeaBlock(AbstractBlock.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.SWEET_BERRY_BUSH),4));
    public static final RegistryObject<HydrangeaBlock> blue_hydrangea = BLOCKS.register("blue_hydrangea", () -> new HydrangeaBlock(AbstractBlock.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.SWEET_BERRY_BUSH), 5));
